...
@Component({
	selector: "app-signup-goals",
	templateUrl: "./signup-goals.page.html",
	styleUrls: [ "./signup-goals.page.scss" ]
})
export class SignupGoalsPage implements OnInit {
	hideMe = false;
	hideMe2: any;
	hideMe3: any;
	twitterGoals: any = [];
	...
	youtube_goals() {
		...
		this.youtubeGoals =
			localStorage.getItem("ygoals") != null &&
			localStorage.getItem("ygoals") != "" &&
			localStorage.getItem("ygoals") != undefined
				? JSON.parse(localStorage.getItem("ygoals"))
				: [];
	...
	twitter_goals() {
		...
		//this.authService.stopLoading();
		this.twitterGoals =
			localStorage.getItem("tgoals") != null &&
			localStorage.getItem("tgoals") != "" &&
			localStorage.getItem("tgoals") != undefined
				? JSON.parse(localStorage.getItem("tgoals"))
				: [];
